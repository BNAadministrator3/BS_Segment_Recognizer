...
from C1_network_evaluation import evaluation, foldermanager
...
if __name__ == '__main__':
    ...
    sys.stdout = logger(filename=os.path.join(os.getcwd(),'log&&materials','Bigloop_20subjectsdesignevalutionresults.log'))
...
#################################################################################################################################
        ...
        for fname in ('mfcc','spec'):
            ...
            src_path = os.path.join(h5folder,'LSTMdesign',lstm_final[0].split('_')[0],lstm_final[0].split('_')[1])
